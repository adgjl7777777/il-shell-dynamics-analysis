"""
Center-of-mass preprocessing pipeline for TFSI anion systems, reading raw
trajectory files and computing per-molecule COM coordinates saved to center.xyz.
"""
import numpy as np
import sys
import os
