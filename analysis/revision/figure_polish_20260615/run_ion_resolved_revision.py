...
RESULTS_DIR  = os.path.join(REVISION_ROOT, "analysis", "figure_polish_20260615", "results")
...
fig, axes = plt.subplots(3, 4, figsize=(13, 8.6), sharey=False)
...
for anion in ANIONS:
    ...
    fig, axes = plt.subplots(n_T, 5, figsize=(16, n_T * 1.35),
